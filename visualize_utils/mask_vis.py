...
def mask_plotter(image, confidence_map, theme, upsample_mode = None, name_plot = True, name = None, save_dir):
...
mask_plotter('./demo_imgs/2007_003711.jpg', dummy, plt.cm.hot, upsample_mode = 'nearest', name="Not Upsampled Confidence", save_dir = './confidence_masks_imgs')